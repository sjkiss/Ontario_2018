...
Second, we calculated bimodality coefficients by self-reported social media usage which are reported in @tbl-bimodality-social-media-policy. Here, however, there is minimal evidence of any polarization. Moreover, we also did not see the pattern noted above whereby polarization increased with online news consumption for voters with low levels of interest. 
...
However, the picture was somewhat different for policy polarization. In this regard, we found that voters who consumed news about the election campaign from online news sources were more polarized than voters who consumed legacy media, although by most standards, it did not qualify as a bimodal distribution. The source of this increased polarization appeared to come from voters who were the least interested in politics. 

It bears emphasizing this is entirely consistent with what we know about a fairly standard Converse-Zaller model of attitude formation where low information voters are the most responsive to exposure of fragments of information. 

It is also consistent with the pattern Merkeley observed in the Canada Election Studies. The overall levels of polarization we measured are roughly in line with what he measured. This analysis differs from his however, in identifying that policy polarization increases dramatically for voters with low levels of interest when they consume strictly digital and online news.  
